...
function Game.Encounter.computeAttack( unit, target )
...
function Game.Encounter.processAttack( data )
...
function Game.Encounter.computeItemUsage( unit, target )
	local data = {};
	data.unit = unit;
	data.target = target;
...
function Game.Encounter.processItemUsage( data )
	data.unit.changeAP( -data.timeConsumed );
