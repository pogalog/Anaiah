...
function UI.createMessage( message, font )
	local text = {};
	text.message = message;
	text.userdata = Text_new( GameInstance, font.userdata, message );
...
function UI.createIntroMessage( message, font )
	local text = {};
	text.message = message;
	text.font = font;
	text.visible = true;
	text.userdata = IntroText_new( Intro, font.userdata, message );
