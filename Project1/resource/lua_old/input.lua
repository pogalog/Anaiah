...
function createController( port )
	...
	controller.button = {};
	controller.state = createControllerState();
	controller.scheme = createControlScheme( controller );
...
function createControlScheme( controller )
...
function createKeyboard( port )
	local kb = {};
	kb.port = port;
	kb.listener = createKeyboardListener( kb );
...
function createKeyboardListener( keyboard )
	local kbl = {};
...
Controller = createController( ControllerPort );
Controller.setDigitalButtons();

Keyboard = createKeyboard( ControllerPort );
