...
function createGameMenu( userdata, font, controlScheme )
	local menu = {};
	menu.items = {};
	...
	-- set defaults
	Menu_setFont( userdata, font );
	Menu_setShader( userdata, menu.shader );
	Menu_setItemShader( userdata, menu.itemShader );
