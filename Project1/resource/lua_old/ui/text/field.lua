...
function createField( message, font )
	local field = {};
	field.message = message;
	field.userdata = Text_new( GameInstance, font, message );
...
function createIntroField( message, font )
	local field = {};
	field.message = message;
	field.font = font;
	field.visible = true;
	field.userdata = IntroText_new( Intro, font, message );
	field.textControl = createKeyboardListener( Keyboard );
